...
class TechListLimit extends StatefulWidget {
  const TechListLimit({super.key});

  @override
  State<TechListLimit> createState() => _TechListLimitState();
}

class _TechListLimitState extends State<TechListLimit> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: techData.take(3).map((data) {
        return Container(
